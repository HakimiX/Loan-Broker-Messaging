...
namespace NormalizerWS
{
    class NormalizerWSApplication
    {
        private const string QUEUE_NAME = "normalizerWS_queue";
        ...
        static void Main(string[] args)
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                Console.WriteLine(" NormalizerWS ready ");
